...
<div class="container my-5">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            <a href="/posts/activites-enfant/eau-traces-ephemeres/" class="text-decoration-none">
                <div class="card h-100 shadow-sm border-0 recipe-card">
                    <img src="/images/uploads/activite-trace-eau-ete-bretigny.jpg" class="card-img-top recipe-card-img" alt="Jeux d'eau traces ephémères proposée aux enfants à Brétigny">
                    <div class="card-body recipe-card-body">
                        <p class="card-text poppins-bold-balise-p text-center text-dark">Activité d’été : traces éphémères au pinceau à l’eau</p>
                    </div>
                </div>
            </a>
        </div>
